...
INSERT INTO widgets(widgetid, name, component, datatype, defaultconfig)
    VALUES ('10000000-0000-0000-0000-000000000001', 'text-widget', 'widgets/text', 'string', '{ "placeholder": "Enter text"}');
...
INSERT INTO nodes(nodeid, name, description, istopnode, ontologyclass, datatype,
            graphid, nodegroupid)
    VALUES ('30000000-0000-0000-0000-000000000004', 'dummy geom node for testing', 'Value of the key', 'f', 'E1_Identifier', 'geometry',
            '22000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001');
